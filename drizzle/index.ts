...
import { users, sessions, emailVerificationRequests } from './schema';
...
export const db = drizzle(client, {
  schema: { users, sessions, emailVerificationRequests },
});
...
type Schema = {
  ...
  emailVerificationRequests: typeof emailVerificationRequests;
};
